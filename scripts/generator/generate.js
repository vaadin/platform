...
const mavenVaadinEePomTemplateFileName = getTemplateFilePath('template-vaadin-ee-pom.xml');
const mavenVaadinEePomResultFileName = getResultsFilePath('vaadin-ee-pom.xml');
...
writer.writeProperty(versions, ["flow"], vaadinQuarkusTemplateFileName, vaadinQuarkusPomResultFileName);
