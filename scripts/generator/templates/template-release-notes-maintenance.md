...
*This is a maintenance release for Vaadin 24.1. See [24.1.0 release notes](https://github.com/vaadin/platform/releases/tag/24.1.0) for details and resources.*
...
- Vaadin Kits
  ...
  - Observability Kit ([{{kits.observability-kit-starter.javaVersion}}](https://github.com/vaadin/observability-kit/releases/tag/{{kits.observability-kit.javaVersion}}))
