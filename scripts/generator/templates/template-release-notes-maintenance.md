...
See the full release notes for vaadin 22.0 in [GitHub releases](https://github.com/vaadin/platform/releases/tag/22.0.0), including new features, getting started, supported browsers and other technologies, and migration notes.
...
## Support
vaadin 22.1 is supported until March 2024 following [Vaadin Commercial License and Service Terms](https://vaadin.com/commercial-license-and-service-terms). More details of our release model are available on our [roadmap page](https://vaadin.com/roadmap).
...
For the full list of how to get started go to the [GitHub releases](https://github.com/vaadin/platform/releases/tag/22.0.0).
