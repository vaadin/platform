...
- Classic Components([{{vaadin.vaadin-classic-components.javaVersion}}](https://vaadin.com/docs/latest/flow/advanced/classic-components))
...
- Vaadin Kits
  ...
  - Collaboration Engine ([{{kits.vaadin-collaboration-engine.javaVersion}}](https://vaadin.com/docs/latest/tools/collaboration))
