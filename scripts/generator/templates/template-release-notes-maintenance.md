...
See the full release notes for Vaadin 14.12 in [GitHub releases](https://github.com/vaadin/platform/releases/tag/14.12.0), including new features, getting started, supported browsers and other technologies, and migration notes.
