...
See the full release notes for Vaadin 14.1 in [GitHub releases](https://github.com/vaadin/platform/releases/tag/14.1.0), including new features, getting started, supported browsers, servers and other technologies, and migration notes.
