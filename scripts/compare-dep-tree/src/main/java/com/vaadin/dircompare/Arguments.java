...
public class Arguments {
    ...
    @Parameter(names = {"-oldVersion"}, description = "Version to compare from", required = true, order = 0)
    public String oldVersion;
    @Parameter(names = {"-newVersion"}, description = "Version to compare against", required = true, order = 1)
