...
async function main() {
  ...
  if (cmd.useOWASP) {
    ...
    !cmd.quick && await run(`mvn org.owasp:dependency-check-maven:check -DnvdApiKey=${process.env.NVD_API_KEY} -DnvdApiDelay=6000 -Dformat=JSON -DautoUpdate=false -q`, { throw: false });
